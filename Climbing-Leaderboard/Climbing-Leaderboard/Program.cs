...
namespace Climbing_Leaderboard
{
    class Program
    {
        ...
        public static List<int> ClimbingLeaderboard(List<int> ranked, List<int> player)
        {
            ...
            newRanked = newRanked.OrderByDescending(x => x).ToList();
            newRanked.Add(0);
